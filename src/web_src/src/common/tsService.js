 ...
 **/
var tsServiceBase_1 = require("./tsServiceBase");
var urlHttps = window.location.origin;
var deviceManage = {
...
var URLS = __assign({}, personalIndex, deviceManage, exportRulesConfig, initial, confirm, passportFilter, illegalDataUpload, prePerform, deviceTypeConfig, notIncludeDevice, algorithmConfig, repeatFilter, { 
    //login
    login: { url: urlHttps + '/business/basic/user/login', method: 'post' }, verify: { url: urlHttps + '/business/basic/verify/validate', method: 'get' }, getAlgorithmVersion: { url: urlHttps + '/system/config/server_version', method: 'get' }, getKey: { url: urlHttps + '/business/basic/user/get_key', method: 'get' }, findPassword: { url: urlHttps + '/business/basic/user/retrieve_password', method: 'post' }, saveproblem: { url: urlHttps + '/business/basic/user/saveproblem', method: 'post' }, checkAnswer: { url: urlHttps + '/business/basic/user/checkproblem', method: 'post' }, updateAnswer: { url: urlHttps + '/business/basic/user/update_problem', method: 'post' }, 
    // 更新密码
    updatePasswd: { url: urlHttps + '/business/basic/user/updatepassword', method: 'post' }, setNewPwd: { url: urlHttps + '/business/basic/user/retrieve_password', method: 'post' }, 
    //App
    getMenu: { url: urlHttps + '/business/basic/menu/get', method: 'get' }, sysLogAdd: { url: urlHttps + '/business/basic/systemlog/add', method: 'post' }, isLogin: { url: urlHttps + '/business/basic/user/islogin', method: 'get' }, 
    //abnormal
    getAbnormalList: { url: urlHttps + '/system/config/recogstatus/get', method: 'get' }, resetAbnormalStatus: { url: urlHttps + '/system/config/recogstatus/reset', method: 'get' }, searchTaskStatus: { url: urlHttps + '/system/config/recogstatus/process', method: 'get' }, saveAbnormalList: { url: urlHttps + '/system/config/recogstatus/save', method: 'post' }, 
    //manageplatform //main
    getTitleIcon: { url: urlHttps + '/system/config/configinfo/getjson', method: 'get' }, logout: { url: urlHttps + '/business/basic/user/logout', method: 'get' }, getEnv: { url: urlHttps + '/system/config/current_env', method: 'get' }, 
    //roadAbnormal
    getDeviceCodeList: { url: urlHttps + '/system/config/missRoad/deviceCodeList', method: 'post' }, getAbnormalRoad: { url: urlHttps + '/system/config/missRoad/list', method: 'get' }, addAbnormalRoad: { url: urlHttps + '/system/config/missRoad/add', method: 'post' }, deleteAbnormalRoad: { url: urlHttps + '/system/config/missRoad/delete', method: 'get' }, closeAbnormalRoad: { url: urlHttps + '/system/config/missRoad/close', method: 'get' }, getAbnormalRoadList: { url: urlHttps + '/system/config/missRoad/roadList', method: 'get' }, 
    //carousel
    getImgPoint: { url: urlHttps + '/business/image/get', method: 'get' }, getDynamicImage: { url: urlHttps + '/business/image/getDynamicImage', method: 'get' }, 
    //illstatable
    illegalCountExport: { url: urlHttps + '/business/illegalstatistics/illegalCountExport', method: 'post' }, getExportProgress: { url: urlHttps + '/business/illegalstatistics/exportprocess', method: 'get' }, getIllegalCountlist: { url: urlHttps + '/business/illegalstatistics/illegalCountList', method: 'post' }, 
    // illgealDataAnalyze
    getRecogstatus: { url: urlHttps + '/business/statistics/recogstatus/list', method: 'post' }, searchTaskProcess: { url: urlHttps + '/system/task/process', method: 'get' }, 
    // searchCondition
    getIllegalPlace: { url: urlHttps + '/system/device/listroadname', method: 'get' }, getIllegalPlaceTree: { url: urlHttps + '/system/device/road_select_tree', method: 'get' }, 
    //systemSouceInfo
    ...
    //specialCar
    getCarList: { url: urlHttps + '/system/config/specialcar/list', method: 'get' }, specialCarUpdate: { url: urlHttps + '/system/config/specialcar/update', method: 'post' }, specialCarAdd: { url: urlHttps + '/system/config/specialcar/add', method: 'post' }, specialCarDelete: { url: urlHttps + '/system/config/specialcar/delete', method: 'get' }, getSpecialCarData: { url: urlHttps + '/system/dict/type/get', method: 'get' }, 
    //dpconfig
    getDpconfig: { url: urlHttps + '/system/config/push/get', method: 'get' }, addConfig: { url: urlHttps + '/system/config/push/add', method: 'post' }, deleteConfig: { url: urlHttps + '/system/config/push/delete', method: 'get' }, setPushType: { url: urlHttps + '/system/config/push/setting', method: 'post' }, 
    ...
    //illegalConfig
    getIllegalList: { url: urlHttps + '/system/config/illegaldict/list', method: 'get' }, getRecogList: { url: urlHttps + '/system/dic/recogillegal/list', method: 'get' }, addIllegalConfig: { url: urlHttps + '/system/config/illegaldict/add', method: 'post' }, updateIllegalConfig: { url: urlHttps + '/system/config/illegaldict/update', method: 'post' }, getRecogillegal: { url: urlHttps + '/system/config/illegaldict/getdictlist', method: 'get' }, 
    //roadAbnormalFilter
    getRoadFilterList: { url: urlHttps + '/system/config/miss_road_filter/list', method: 'get' }, getFilterRoadList: { url: urlHttps + '/system/config/miss_road_filter/roadList', method: 'get' }, getFilterRoadDevice: { url: urlHttps + '/system/config/miss_road_filter/deviceCodeList', method: 'post' }, addFilterRoad: { url: urlHttps + '/system/config/miss_road_filter/add', method: 'post' }, deleteFilterRoad: { url: urlHttps + '/system/config/miss_road_filter/delete', method: 'get' }, closeFilterRoad: { url: urlHttps + '/system/config/miss_road_filter/close', method: 'get' }, openFilterRoad: { url: urlHttps + '/system/config/miss_road_filter/open', method: 'get' }, 
    // check
    //获取车管所数据
    getVehicleData: { url: urlHttps + '/business/vehicledata/get', method: 'get' }, getCarPlateImg: { url: urlHttps + '/business/image/car_plate', method: 'get' }, 
    //statistics
    illegalStatList: { url: urlHttps + '/business/illegalstatistics/illegalStatList', method: 'post' }, illegalSearch: { url: urlHttps + '/business/illegalsearch/data', method: 'post' }, illegalsearchExportAdd: { url: urlHttps + '/business/illegalsearch/export/add', method: 'post' }, illegalsearchExportGet: { url: urlHttps + '/business/illegalsearch/export/get', method: 'get' }, illegalSearchDetail: { url: urlHttps + '/business/illegalsearch/detail', method: 'post' }, statisticsExport: { url: urlHttps + '/business/illegalstatistics/illegalStatExport', method: 'post' }, getReuploadArr: { url: urlHttps + '/business/illegalsearch/uploadStatusList', method: 'post' }, reuploadAdd: { url: urlHttps + '/client/publish/fail_republish/add', method: 'post' }, reuploadProgress: { url: urlHttps + '/business/task/process/get', method: 'get' }, 
    //carWhiteList
    getWhiteList: { url: urlHttps + '/system/config/whitelist/list', method: 'get' }, addWhiteList: { url: urlHttps + '/system/config/whitelist/add', method: 'post' }, deleteWhiteList: { url: urlHttps + '/system/config/whitelist/delete', method: 'get' }, 
    //illegalBahaviorFilter
    getIllegalFilterList: { url: urlHttps + '/system/config/illegal_filter/list', method: 'get' }, addFilterIllegal: { url: urlHttps + '/system/config/illegal_filter/add', method: 'post' }, deleteFilterIllegal: { url: urlHttps + '/system/config/illegal_filter/delete', method: 'get' }, 
    //departmentManage
    getDepartList: { url: urlHttps + '/business/basic/dept/list', method: 'get' }, addDepart: { url: urlHttps + '/business/basic/dept/add', method: 'post' }, updateDepart: { url: urlHttps + '/business/basic/dept/update', method: 'post' }, deleteDepart: { url: urlHttps + '/business/basic/dept/delete', method: 'post' }, getNoDepUserList: { url: urlHttps + '/business/basic/user/no_dept_list', method: 'get' }, 
    //roleManage
    getRoleList: { url: urlHttps + '/business/basic/role/list', method: 'get' }, getUpdateRole: { url: urlHttps + '/business/basic/role/update', method: 'post' }, getDisplayMenu: { url: urlHttps + '/business/basic/menu/get_display_menu', method: 'get' }, getRoleByUser: { url: urlHttps + '/business/basic/role/getRoleByUserName', method: 'get' }, 
    //deviceRulesConfig
    getProjectList: { url: urlHttps + '/system/project/list', method: 'get' }, addProject: { url: urlHttps + '/system/project/add', method: 'post' }, exportFile: { url: urlHttps + '/system/project/export', method: 'get' }, getTaskExportProgress: { url: urlHttps + '/system/task/process', method: 'get' }, getDeviceRules: { url: urlHttps + '/system/device/rule/get', method: 'get' }, updateDeviceRules: { url: urlHttps + '/system/project/rule/update', method: 'post' }, getProjectArr: { url: urlHttps + '/system/project/get', method: 'get' }, 
    //App
    getStatus: { url: urlHttps + '/system/monitor/service/corestatus', method: 'get' }, 
    //illegalRelationship
    getIllegalRelationship: { url: urlHttps + '/system/config/business/list', method: 'get' }, saveIllegalRelationship: { url: urlHttps + '/system/config/business/save', method: 'post' }, 
    //abnormalDeviceWarning
    getAbnormalData: { url: urlHttps + '/system/device/warn/stat', method: 'post' }, reasonstat: { url: urlHttps + '/system/device/warn/reasonstat', method: 'post' }, exportWarn: { url: urlHttps + '/system/device/warn/export', method: 'get' }, exportWarnProgress: { url: urlHttps + '/system/device/warn/exportprogress', method: 'get' }, 
    //abnormalDeviceconfig
    getAbnormalConfig: { url: urlHttps + '/system/device/warn/config', method: 'get' }, saveAbnormalData: { url: urlHttps + '/system/device/warn/modconfig', method: 'post' }, addAbnormalData: { url: urlHttps + '/system/device/warn/addconfig', method: 'post' }, 
    //iacongfig
    addIaIllegal: { url: urlHttps + '/system/config/illegal/add', method: 'post' }, updateIaIllegal: { url: urlHttps + '/system/config/illegal/update', method: 'post' }, getdictlist: { url: urlHttps + '/system/config/illegal/getdictlist', method: 'get' }, 
    //taskDispatch
    getTaskTemplate: { url: urlHttps + '/system/crontask/get_template_list', method: 'get' }, addTaskJob: { url: urlHttps + '/system/crontask/add_job', method: 'post' }, updateTaskJob: { url: urlHttps + '/system/crontask/update_job', method: 'post' }, deleteTaskJob: { url: urlHttps + '/system/crontask/delete_job', method: 'get' }, getTaskJob: { url: urlHttps + '/system/crontask/get_task_list', method: 'get' }, getTaskJobLog: { url: urlHttps + '/system/crontask/exec/status/log', method: 'get' }, executeJobNow: { url: urlHttps + '/system/crontask/execute_job_now', method: 'get' }, switchTaskJob: { url: urlHttps + '/system/crontask/onoff', method: 'post' } });
function configAjax(urlType, params) {
    var _a = URLS[urlType], url = _a.url, method = _a.method;
    return tsServiceBase_1.request(url, method, params);
}
exports.configAjax = configAjax;
